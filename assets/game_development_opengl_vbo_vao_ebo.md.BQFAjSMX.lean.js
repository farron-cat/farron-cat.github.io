import{_ as t,c as r,o,j as e}from"./chunks/framework.U1Gow_7P.js";const f=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"game_development/opengl/vbo&vao&ebo.md","filePath":"game_development/opengl/vbo&vao&ebo.md"}'),l={name:"game_development/opengl/vbo&vao&ebo.md"};function a(p,n,O,s,B,V){return o(),r("div",null,n[0]||(n[0]=[e("p",null,"在OpenGL中，VBO（Vertex Buffer Object）、VAO（Vertex Array Object） 和 EBO（Element Buffer Object） 是优化渲染性能的核心技术，它们共同管理顶点数据并减少CPU-GPU通信 VBO 顶点缓冲对象（Vertex Buffer Objects 作用 存储顶点属性数据（位置、颜色、法线、纹理坐标等）",-1),e("pre",null,[e("code",null,`功能
