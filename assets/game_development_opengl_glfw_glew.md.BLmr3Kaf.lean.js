import{_ as n,c as t,o as p,j as e}from"./chunks/framework.Ck3L_38O.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"game_development/opengl/glfw&glew.md","filePath":"game_development/opengl/glfw&glew.md"}'),a={name:"game_development/opengl/glfw&glew.md"};function o(r,l,s,d,g,m){return p(),t("div",null,[...l[0]||(l[0]=[e("p",null,"使用二者的来由 由于OpenGL本身只是图形渲染api，并不涉及其他方面的功能 不负责创建应用程序窗口 不负责处理操作系统消息（事件循环 不负责处理输入",-1),e("pre",null,[e("code",null,`由于OpenGL驱动由显卡厂商提供，不同显卡、不同驱动版本的核心功能和扩展功能差异大
    核心函数位置可能不同
